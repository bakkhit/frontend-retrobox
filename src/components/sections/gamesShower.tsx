...
const GamesShower = () => {
  ...
  return (
    <div className="relative w-full h-[35vw] min-h-[250px] max-h-[600px] bg-[#050D1D] flex flex-col justify-between gap-[1vw]">
      ...
      <div className="w-full overflow-hidden">
        <div className="infinite-scroll h-[10vw] items-center">
          {repeatedSrcs1.map((src, index) => (
            <div
              key={`b1-${index}`}
              className="mx-2 aspect-square bg-center bg-cover flex-shrink-0 rounded-xl"
              style={{
