...
const Header = () => {
    return(
      <header className="flex sticky top-0 w-full h-20 justify-between items-center bg-gradient-to-b from-[#171C5C]/80 to-[#2F3075]/80 px-4 z-20 border-b-2 border-[#171C5C]">
